...
<link rel="stylesheet" href="{{ URL::asset('font/mltokyo/mltokyo.css')}}">
<link rel="stylesheet" href="{{ URL::asset('font/pfbague/pfbague.css')}}">
<link rel="stylesheet" href="{{ URL::asset('font/gilroy/gilroy.css')}}">