    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 align-self-center">
                <h2 class="display-5 text-white font-weight-light"><b class="text-white font-weight-bold">Kreasi Bangsa</b> memungkinkan kamu menyimpan kreasi /
                    karya </h2>
                {{-- <hr class="my-4"> --}}
                <p class="mb-4 text-white" style="font-size: 16px;">Kreasi bangsa merupakan sarana untuk mengenalkan kreasi - kreasi anak bangsa, mulai
                    dari
                    sketch,
